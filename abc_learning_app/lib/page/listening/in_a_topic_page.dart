...
class ListenTopicPage extends StatefulWidget {
  const ListenTopicPage({super.key});
                      ...
                      Expanded(
                        child: Center(
                          child: YoutubePlayer(
                            ...
                            progressIndicatorColor: ColorPalette.primaryColor,
                          ),
                        ),
                      ),
                      ElevatedButton(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: TextStyles.questionResult.copyWith(
                                  color: Colors.grey,
                                ),
                                ...
                                disabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                  borderSide: BorderSide(
                                    color: trueAnswer.trim().toLowerCase() ==
                                            textController.text
                                                .trim()
                                                .toLowerCase()
                                        ? Colors.green
